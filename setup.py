...
import numpy
#Original repo: https://github.com/aboev/pymqlib
...
```
"""
#we need absolute path to the location of this file
path_mqlib = os.path.abspath(os.path.dirname(__file__))
...
setup(name = "MQLib",
      ...
      ext_modules = [Extension(f"{path_mqlib}/_MQLib",
